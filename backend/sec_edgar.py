...
# Override with the SEC_USER_AGENT env var when deploying (e.g. on Render),
# so your email isn't hardcoded in a public repo.
USER_AGENT = os.environ.get(
    "SEC_USER_AGENT",
    "Corporate Debt Risk Dashboard (contact: your-email@example.com)",
)
